      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex flex-col lg:flex-row items-end justify-between mb-20 gap-8">
          <div className="max-w-2xl space-y-4 text-center lg:text-left">
            ...
            >
              <div className="w-2 h-2 bg-[#7191e6] rotate-45" />
              <span className="text-[#3d52a1] font-black uppercase tracking-[0.3em] text-xs">Our Expertise</span>
            </motion.div>
            <motion.h2 
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              className="text-4xl md:text-4xl lg:text-5xl font-black text-black uppercase"
            >
              CORE SERVICES & <br /> <span className="text-[#7191e6] ">CAPABILITIES</span>
            </motion.h2>
          </div>
          <motion.p 
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            className="text-slate-500 font-bold uppercase italic text-sm border-l-2 border-[#7191e6] pl-6 max-w-xs text-left"
          >
          ...
          {services.map((item, idx) => (
            ...
            >
              <div className="relative z-10 space-y-6">
                ...
                <h3 className="text-2xl font-black text-black uppercase italic leading-tight tracking-tight group-hover:text-[#3d52a1] transition-colors">
                  {item.title}
                </h3>
