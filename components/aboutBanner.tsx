...
const TradingHero = () => {
  return (
    <section className="relative min-h-screen bg-[#dfe8e6] text-white overflow-hidden flex items-center">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#3d52a1]/20 via-[#7191e6]/20 to-[#3d52a1]/20 animate-pulse blur-3xl" />
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          <h1 className="text-3xl md:text-4xl text-black font-bold leading-tight">
            ...
            <span className="block text-[#3d52a1]">The Gap is Real. We Bridge It.</span>
          </h1>
        ...
        {/* Right UI */}
        <div className="bg-gradient-to-br from-gray-900 to-black border border-[#7191e6]/40 rounded-xl p-6 shadow-xl backdrop-blur">
          <div className="text-sm text-gray-400 mb-4">
            Enterprise Ready Talent Preview
          </div>

          <div className="h-48 bg-gradient-to-t from-[#3d52a1]/20 to-transparent rounded-lg flex items-end">
