      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center mb-20">
          ...
          >
            <div className="flex items-center gap-4 mb-6">
               <span className="h-px w-10 bg-[#7191e6]"></span>
               <span className="text-[#7191e6] text-[10px] font-black uppercase tracking-[0.4em]">Talent Node / v4.0</span>
            </div>
            <h2 className="text-4xl md:text-4xl lg:text-5xl font-black text-black  tracking-tighter uppercase leading-[0.8] mb-8 italic">
              Performance <br />
              <span className="text-[#7191e6] not-italic">Validated</span>
            </h2>
          ...
          >
            ...
            <div className="h-[400px] w-full bg-gray-100 rounded-[2.5rem] overflow-hidden relative shadow-2xl">
              <img 
                src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=800&q=80" 
                alt="Talent Collaboration"
                className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-1000 scale-110 group-hover:scale-100"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#3d52a1]/80 to-transparent flex flex-col justify-end p-10">
                 <p className="text-white text-[10px] font-black tracking-[0.5em] uppercase mb-2">Internal_System_View</p>
                 <p className="text-white/70 text-xs italic">&quot;Trained to integrate seamlessly into workflows.&quot;</p>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          {talents.slice(0, 2).map((t, i) => (
            <motion.div key={i} className="p-10 border border-gray-100 rounded-[2rem] hover:bg-gray-50 transition-all group">
               <span className="text-[9px] font-mono text-[#7191e6] mb-4 block">// {t.code}</span>
               <h3 className="text-xl font-black text-[#3d52a1] uppercase mb-4">{t.title}</h3>
               <p className="text-xs text-gray-500 leading-relaxed">{t.desc}</p>
            </motion.div>
          ))}

          {/* TECH IMAGE 2: Small Grid Image */}
          <motion.div className="lg:col-span-2 h-[250px] bg-gray-50 rounded-[2rem] overflow-hidden relative border border-gray-100 group">
             <img 
             ...
             <div className="absolute top-6 left-6 p-4 bg-white/90 backdrop-blur-md rounded-xl border border-gray-100">
                <p className="text-[#3d52a1] text-[10px] font-black tracking-widest uppercase">Pod_Active</p>
             </div>
          </motion.div>
          ...
          {/* FINAL DARK BLOCK */}
          <div className="lg:col-span-2 bg-[#3d52a1] p-12 rounded-[2rem] text-white flex flex-col justify-between">
             <p className="text-3xl font-black italic uppercase leading-tight tracking-tighter">
